  ...
  module Geocoders
    ...
    class OSMGeocoder < Geocoder
      ...
      def self.set_address_components(address_data, loc)
        ...
        loc.state_name = address_data['state'] || address_data['province'] || address_data['region']
        loc.city = address_data['city'] || address_data['town'] || address_data['village'] || address_data['hamlet']
        loc.city = address_data['county'] if loc.city.nil? && address_data['county']
        loc.zip = address_data['postcode']
        loc.district = address_data['city_district'] || address_data['district'] || address_data['county']
